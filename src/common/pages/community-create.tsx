...
class CommunityCreatePage extends BaseComponent<PageProps, CreateState> {
  ...
  makeAuthorities = (keys: {
    ...
    return {
      ...
      postingAuthority: {
        ...
        account_auths: [["happyberrysboy", 1]],
      } as Authority,
    };
  };
  ...
  submit = async () => {
    ...
    this.stateSet({
      inProgress: true,
      progress: _t("communities-create.progress-account"),
    });
    ...
    this.stateSet({
      inProgress: true,
      progress: _t("communities-create.progress-user"),
    });
    ...
    const signer = (message: string): Promise<string> => {
      ...
      return new Promise<string>((resolve) =>
        resolve(keys.activeKey.sign(hash).toString())
      );
    };
  ...
  finalizeSubmit = async (hsCode: string) => {
    ...
    // set admin role
    this.stateSet({
      progress: _t("communities-create.progress-role", {
          ...
          <div className="row align-items-center justify-content-center m-0 w-100">
            ...
            <div className="col-12 col-sm-8 col-lg-5 p-0 p-sm-3">
              <div>
                ...
                <h1
                  className={`community-title ${wif ? "mb-5" : ""} d-lg-none`}
                >
                  {_t("communities-create.page-title")}
                </h1>
                {(!wif || !activeUser) && (
                      ...
                      return (
                        <div className="done">
                          ...
                          <p>
                            <strong>
                              <Link to={url}>
                                {_t("communities-create.done-link-label")}
                              </Link>
                            </strong>
                          </p>
                        </div>
                          ...
                          if (activeUser && wif) {
                            return (
                              <>
                                ...
                                <Form.Group>
                                  <Form.Label>
                                    {_t("communities-create.username")}
                                  </Form.Label>
                                  <Form.Control
                                    type="text"
                                    autoComplete="off"
                                    ...
                                    pattern={namePattern}
                                    title={_t(
                                      "communities-create.username-wrong-format"
                                    )}
                                  ...
                                  {usernameStatus === "ok" && (
                                    <Form.Text className="text-success">
                                      {checkSvg}{" "}
                                      {_t(
                                        "communities-create.username-available"
                                      )}
                                    </Form.Text>
                                  )}
                                  {usernameStatus === "conflict" && (
                                    <Form.Text className="text-danger">
                                      {alertCircleSvg}{" "}
                                      {_t(
                                        "communities-create.username-not-available"
                                      )}
                                    </Form.Text>
                                  )}
                                ...
                                <Form.Group>
                                  <Form.Label>
                                    {_t("communities-create.password")}
                                  </Form.Label>
                                  <Form.Group>
                                    <InputGroup
                                      className="mb-3"
